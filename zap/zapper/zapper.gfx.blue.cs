...
datablock ParticleData(BlueZapperProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(BlueZapperProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "BlueZapperProjectileImpact_Smoke";
};

datablock DebrisData(BlueZapperProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(BlueZapperProjectileImpact)
{
	...
	lifetimeMS = 3000;
 	...
 	// shape...
	explosionShape = "ethernet/data/weapons/blaster/projectile.impact.blue.dts";
	faceViewer = false;
	playSpeed = 0.4;
	sizes[0] = "1 1 1";
	sizes[1] = "1 1 1";
	...
	emitter[0] = BlueZapperProjectileImpact_SmokeEmitter;

	debris = BlueZapperProjectileImpact_Debris;
	debrisThetaMin = 0;
	debrisThetaMax = 60;
	debrisNum = 1;
	debrisNumVariance = 1;
