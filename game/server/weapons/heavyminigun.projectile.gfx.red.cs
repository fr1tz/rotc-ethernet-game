...
datablock ParticleData(RedHeavyMinigunProjectileParticleEmitter_Particles)
{
	dragCoefficient      = 1;
...
datablock ParticleEmitterData(RedHeavyMinigunProjectileParticleEmitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 2;
	ejectionVelocity = 5;
	...
	lifetimeMS		 = 0;
	particles = "RedHeavyMinigunProjectileParticleEmitter_Particles";
};

//-----------------------------------------------------------------------------
// laser tail...

datablock LaserBeamData(RedHeavyMinigunProjectileLaserTail)
{
	hasLine = true;
...
datablock MultiNodeLaserBeamData(RedHeavyMinigunProjectileLaserTrail)
{
	hasLine = false;
...
datablock ParticleData(RedHeavyMinigunProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(RedHeavyMinigunProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "RedHeavyMinigunProjectileImpact_Smoke";
};

datablock ParticleData(RedHeavyMinigunProjectileImpact_DebrisParticle)
{
	dragCoefficient		= 1;
...
datablock ParticleEmitterData(RedHeavyMinigunProjectileImpact_DebrisEmitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 0;
	...
	particles = "RedHeavyMinigunProjectileImpact_DebrisParticle";
};


datablock DebrisData(RedHeavyMinigunProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(RedHeavyMinigunProjectileImpact)
{
	...
	emitter[1] = RedHeavyMinigunProjectileImpact_SmokeEmitter;

	//debris = RedHeavyMinigunProjectileImpact_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 1;
	//debrisNumVariance = 1;
...
datablock ParticleData(RedHeavyMinigunProjectileHit_Particle)
{
	dragCoefficient    = 0.0;
	windCoefficient    = 0.0;
	gravityCoefficient	= 0.0;
...
datablock ParticleEmitterData(RedHeavyMinigunProjectileHit_Emitter)
{
	ejectionOffset	= 0;
	...
	particles = "RedHeavyMinigunProjectileHit_Particle";
};

datablock ExplosionData(RedHeavyMinigunProjectileHit)
{
	soundProfile = HeavyMinigunProjectileImpactSound;

	lifetimeMS = 450;

	particleEmitter = RedHeavyMinigunProjectileHit_Emitter;
	particleDensity = 1;
	particleRadius = 0;
...
datablock ExplosionData(RedHeavyMinigunProjectileMissedEnemyEffect)
{
	...
	emitter[0] = RedHeavyMinigunProjectileImpact_SmokeEmitter;
