...
exec("./sniperrifle2.sfx.cs");
exec("./sniperrifle2.projectile.cs");

//------------------------------------------------------------------------------

datablock ShapeBaseImageData(HolsteredSniperRifle2Image)
{
...
datablock ShapeBaseImageData(RedSniperRifle2Image)
{
	...
	projectile = RedSniperRifle2Projectile;
	...
	//
		...
		stateFire[5]                     = true;
		stateFireProjectile[5]           = RedSniperRifle2Projectile;
...
function RedSniperRifle2Image::onMount(%this, %obj, %slot)
{
    Parent::onMount(%this, %obj, %slot);
}

function RedSniperRifle2Image::onUnmount(%this, %obj, %slot)
{
...
function RedSniperRifle2Image::onCharge(%this, %obj, %slot)
{
	//error("onCharge");
    %obj.sniperTarget = "";
    %obj.setSniping(true);
...
function RedSniperRifle2Image::onFire(%this, %obj, %slot)
{
	//error("onFire");
    %obj.setSniping(false);
}

function RedSniperRifle2Image::onNoAmmo(%this, %obj, %slot)
{
	//error("onNoAmmo");
    %obj.setSniping(false);
}
...
datablock ShapeBaseImageData(BlueSniperRifle2Image : RedSniperRifle2Image)
{
	shapeFile = "share/shapes/rotc/weapons/missilelauncher/image2.blue.dts";

	projectile = BlueSniperRifle2Projectile;
    missile = BlueSniperMissile;

	stateFireProjectile[5] = BlueSniperRifle2Projectile;
	stateEmitter[6] = BlueMissileLauncherFireEmitter;
	stateEmitter[7] = BlueMissileLauncherFireEmitter;
};

function BlueSniperRifle2Image::onMount(%this, %obj, %slot)
{
	RedSniperRifle2Image::onMount(%this, %obj, %slot);
}
...
{
    RedSniperRifle2Image::onReady(%this, %obj, %slot);
}

function BlueSniperRifle2Image::onCharge(%this, %obj, %slot)
{
    RedSniperRifle2Image::onCharge(%this, %obj, %slot);
}

function BlueSniperRifle2Image::onFire(%this, %obj, %slot)
{
	RedSniperRifle2Image::onFire(%this, %obj, %slot);
}

function BlueSniperRifle2Image::onNoAmmo(%this, %obj, %slot)
{
    RedSniperRifle2Image::onNoAmmo(%this, %obj, %slot);
}
