...
exec("./heavyminigun.projectile.cs");
exec("./heavyminigun.sfx.cs");

//-----------------------------------------------------------------------------
// fire particle emitter

datablock ParticleData(HeavyMinigunFireEmitter_Particles)
{
	dragCoefficient       = 1;
...
datablock ParticleEmitterData(HeavyMinigunFireEmitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 0;
	...
	lifetimeMS       = 0;
	particles        = "HeavyMinigunFireEmitter_Particles";
};
...
datablock ShapeBaseImageData(RedHeavyMinigunImage)
{
	...
	projectile = RedHeavyMinigunProjectile;
	...
	//
		...
		stateSound[3]                    = HeavyMinigunSpinUpSound;
		...
		stateSound[9]                    = HeavyMinigunSpinSound;
		...
		stateSound[4]                    = HeavyMinigunFireSound;
		stateEmitter[4]                  = HeavyMinigunFireEmitter;
		...
		stateSound[5]                    = HeavyMinigunSpinDownSound;
...
function RedHeavyMinigunImage::onFire(%this, %obj, %slot)
{
...
datablock ShapeBaseImageData(BlueHeavyMinigunImage : RedHeavyMinigunImage)
{
	shapeFile = "share/shapes/rotc/weapons/minigun/image2.blue.dts";
	projectile = BlueHeavyMinigunProjectile;
	//stateEmitter[3] = BlueHeavyMinigunFireEmitter;
};

function BlueHeavyMinigunImage::onFire(%this, %obj, %slot)
{
	RedHeavyMinigunImage::onFire(%this, %obj, %slot);
}
