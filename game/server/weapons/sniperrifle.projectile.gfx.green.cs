...
datablock MultiNodeLaserBeamData(GreenSniperProjectileLaserTrailOne)
{
	hasLine   = false;
   ...
   lineWidth = 2.0;
	...
	bitmap = "share/textures/rotc/laser1.green";
	bitmapWidth = 2.4;
...
datablock MultiNodeLaserBeamData(GreenSniperProjectileLaserTrailThree)
{
	hasLine   = false;
	...
	bitmap = "share/textures/rotc/smoke3.green";
	bitmapWidth = 1.5;
...
datablock ExplosionData(GreenSniperProjectileExplosion : GreenSniperProjectileHit)
{
	...
	//debris = SniperProjectileExplosion_LargeDebris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 80;
	//debrisNum = 6;
   //debrisNumVariance = 0;
	...
	//particleEmitter = GreenSniperProjectileExplosion_DustEmitter;
	//particleDensity = 15;
	//particleRadius = 2;

	emitter[0] = SniperProjectileExplosion_DebrisEmitter;
	emitter[1] = GreenSniperProjectileExplosion_SmokeEmitter;
	//emitter[2] = GreenSniperProjectileExplosion_SparksEmitter;

	// Dynamic light
	lightStartRadius = 0;
	lightEndRadius = 0;
	lightStartColor = "0.0 1.0 0.0 1.0";
	lightEndColor = "0.0 1.0 0.0 0.0";
};
