...
datablock ParticleData(RedBlaster4ProjectileParticleEmitter_Particles)
{
	dragCoefficient      = 1;
...
datablock ParticleEmitterData(RedBlaster4ProjectileParticleEmitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 2;
	ejectionVelocity = 5;
	...
	lifetimeMS		 = 0;
	particles = "RedBlaster4ProjectileParticleEmitter_Particles";
};

//-----------------------------------------------------------------------------
// laser tail...

datablock LaserBeamData(RedBlaster4ProjectileLaserTail)
{
	hasLine = true;
...
datablock MultiNodeLaserBeamData(RedBlaster4ProjectileLaserTrail)
{
	hasLine = true;
...
datablock ParticleData(RedBlaster4ProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(RedBlaster4ProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "RedBlaster4ProjectileImpact_Smoke";
};

datablock DebrisData(RedBlaster4ProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(RedBlaster4ProjectileImpact)
{
	soundProfile = Blaster4ProjectileImpactSound;
	...
	emitter[1] = RedBlaster4ProjectileImpact_SmokeEmitter;

	//debris = RedBlaster4ProjectileImpact_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 1;
	//debrisNumVariance = 1;
...
datablock ParticleData(RedBlaster4ProjectileHit_Particle)
{
	dragCoefficient    = 0.0;
	windCoefficient    = 0.0;
	gravityCoefficient	= 0.0;
...
datablock ParticleEmitterData(RedBlaster4ProjectileHit_Emitter)
{
	ejectionOffset	= 0;
	...
	particles = "RedBlaster4ProjectileHit_Particle";
};

datablock ExplosionData(RedBlaster4ProjectileHit)
{
	soundProfile = Blaster4ProjectileImpactSound;

	lifetimeMS = 450;

	particleEmitter = RedBlaster4ProjectileHit_Emitter;
	particleDensity = 1;
	particleRadius = 0;
...
datablock ExplosionData(RedBlaster4ProjectileMissedEnemyEffect)
{
	soundProfile = Blaster4ProjectileMissedEnemySound;
