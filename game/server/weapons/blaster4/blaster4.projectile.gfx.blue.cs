...
datablock LaserBeamData(BlueBlaster4ProjectileLaserTail)
{
	hasLine = true;
...
datablock MultiNodeLaserBeamData(BlueBlaster4ProjectileLaserTrail)
{
	hasLine = true;
...
datablock ParticleData(BlueBlaster4ProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(BlueBlaster4ProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "BlueBlaster4ProjectileImpact_Smoke";
};

datablock DebrisData(BlueBlaster4ProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(BlueBlaster4ProjectileImpact)
{
	...
	emitter[1] = BlueBlaster4ProjectileImpact_SmokeEmitter;

	//debris = BlueBlaster4ProjectileImpact_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 1;
	//debrisNumVariance = 1;
...
datablock ParticleData(BlueBlaster4ProjectileHit_Particle)
{
	dragCoefficient    = 0.0;
	windCoefficient    = 0.0;
...
datablock ParticleEmitterData(BlueBlaster4ProjectileHit_Emitter)
{
	ejectionOffset	= 0;
	...
	particles = "BlueBlaster4ProjectileHit_Particle";
};

datablock ExplosionData(BlueBlaster4ProjectileHit)
{
	soundProfile = Blaster4ProjectileImpactSound;

	lifetimeMS = 450;

	particleEmitter = BlueBlaster4ProjectileHit_Emitter;
	particleDensity = 1;
	particleRadius = 0;
...
datablock ExplosionData(BlueBlaster4ProjectileMissedEnemyEffect)
{
